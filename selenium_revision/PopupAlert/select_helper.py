...
class SelectOptions:
    ...
    def select_by_text(self,id1, text):
        try:
            drop_element =  self.driver.find_element(By.ID, id1)
            drop_option = Select(drop_element)
            drop_option.select_by_visible_text(text =text)
    ...
    def select_by_value(self, val):
        try:
            drop_element = self.driver.find_element(By.ID, "dropdown")
            drop_option = Select(drop_element)
            drop_option.select_by_value(val)
