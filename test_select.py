...
def test_select_text_java():
    obj1 = SelectOptions()
    assert obj1.select_by_text("Java"),'Failed due to text'

def test_select_text_python():
    obj1 = SelectOptions()
    assert obj1.select_by_text("Python"),'Failed due to text'

def test_select_text_react():
    obj1 = SelectOptions()
    assert obj1.select_by_text("React"),'Failed due to text'

def test_select_text_azure():
    obj1 = SelectOptions()
    assert obj1.select_by_text("Azure"),'Failed due to text'
